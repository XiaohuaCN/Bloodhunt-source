...
// Function:
//		Offset -> 0x016C0340
//		Name   -> Function TBP_RangedWeapon_Shotgun_DoubleBarreled.TBP_RangedWeapon_Shotgun_DoubleBarreled_C.OnHitAuthority
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function TBP_RangedWeapon_Shotgun_DoubleBarreled.TBP_RangedWeapon_Shotgun_DoubleBarreled_C.OnHitAuthority");

	UTBP_RangedWeapon_Shotgun_DoubleBarreled_C_OnHitAuthority_Params params;
...
// Function:
//		Offset -> 0x016C0340
//		Name   -> Function TBP_RangedWeapon_Shotgun_DoubleBarreled.TBP_RangedWeapon_Shotgun_DoubleBarreled_C.CalculateBulletDirection
...
struct FVector UTBP_RangedWeapon_Shotgun_DoubleBarreled_C::CalculateBulletDirection(const struct FVector& InAimDirection, struct FTigerRangedRandomState* InOutRandomState, int InBulletIndex, class UTigerRangedWeaponComponent* InRangedWeaponComponent)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function TBP_RangedWeapon_Shotgun_DoubleBarreled.TBP_RangedWeapon_Shotgun_DoubleBarreled_C.CalculateBulletDirection");

	UTBP_RangedWeapon_Shotgun_DoubleBarreled_C_CalculateBulletDirection_Params params;
