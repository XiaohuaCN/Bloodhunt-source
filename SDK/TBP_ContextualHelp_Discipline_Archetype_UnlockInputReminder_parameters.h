...
struct UTBP_ContextualHelp_Discipline_Archetype_UnlockInputReminder_C_OnPlayerSpawned_Params
{
...
struct UTBP_ContextualHelp_Discipline_Archetype_UnlockInputReminder_C_OnDisciplineUnlocked_Params
{
	Tiger_ETigerDisciplineSlot                         InDisciplineSlot;                                          // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UTBP_ContextualHelp_Discipline_Archetype_UnlockInputReminder_C_ExecuteUbergraph_TBP_ContextualHelp_Discipline_Archetype_UnlockInputReminder_Params
{
