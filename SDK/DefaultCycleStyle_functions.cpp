...
// Function:
//		Offset -> 0x016C0340
//		Name   -> Function DefaultCycleStyle.DefaultCycleStyle_C.DetermineNextWeaponSlot
...
Tiger_ETigerWeaponSlot UDefaultCycleStyle_C::DetermineNextWeaponSlot(class ATigerPlayerController* InPlayerController, Tiger_ETigerWeaponCycleDirection InDirection)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function DefaultCycleStyle.DefaultCycleStyle_C.DetermineNextWeaponSlot");

	UDefaultCycleStyle_C_DetermineNextWeaponSlot_Params params;
