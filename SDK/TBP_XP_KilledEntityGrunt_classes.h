...
class UTBP_XP_KilledEntityGrunt_C : public UTigerExperienceEvent
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass TBP_XP_KilledEntityGrunt.TBP_XP_KilledEntityGrunt_C");
		return ptr;
	}
