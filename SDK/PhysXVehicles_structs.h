...
struct FWheelSetup
{
	...
	unsigned char                                      UnknownData_A9LN[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FTireConfigMaterialFriction
{
	...
	unsigned char                                      UnknownData_I5S2[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FVehicleDifferential4WData
{
	...
	unsigned char                                      UnknownData_C0HP[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVehicleTransmissionData
{
	...
	unsigned char                                      UnknownData_BX2C[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F16T[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FVehicleEngineData
{
	...
	unsigned char                                      UnknownData_I6O7[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IFZ3[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_B2LQ[0x10];                                    // 0x0760(0x0010) MISSED OFFSET (PADDING)
