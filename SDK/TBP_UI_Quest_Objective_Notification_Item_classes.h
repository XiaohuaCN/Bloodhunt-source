...
public:
	...
	class UTigerStyledRichTextBlock*                   QuestObjectiveText;                                        // 0x0298(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TBP_UI_Quest_Objective_Notification_Item.TBP_UI_Quest_Objective_Notification_Item_C");
		return ptr;
	}



	void SetupDataFromQuestObjective(class UTigerQuestObjective* TigerQuestObjective);
	void Construct();
