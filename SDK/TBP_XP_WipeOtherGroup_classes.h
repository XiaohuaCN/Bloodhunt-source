...
class UTBP_XP_WipeOtherGroup_C : public UTigerExperienceEvent
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass TBP_XP_WipeOtherGroup.TBP_XP_WipeOtherGroup_C");
		return ptr;
	}
