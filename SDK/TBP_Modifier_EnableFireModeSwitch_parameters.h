...
struct UTBP_Modifier_EnableFireModeSwitch_C_OnModEquipped_Params
{
...
struct UTBP_Modifier_EnableFireModeSwitch_C_OnModUnequipped_Params
{
	class UTigerEquippedModModifierValues*             Modifiers;                                                 // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UTBP_Modifier_EnableFireModeSwitch_C_ExecuteUbergraph_TBP_Modifier_EnableFireModeSwitch_Params
{
