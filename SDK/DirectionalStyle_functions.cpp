...
// Function:
//		Offset -> 0x016C0340
//		Name   -> Function DirectionalStyle.DirectionalStyle_C.DetermineNextWeaponSlot
...
Tiger_ETigerWeaponSlot UDirectionalStyle_C::DetermineNextWeaponSlot(class ATigerPlayerController* InPlayerController, Tiger_ETigerWeaponCycleDirection InDirection)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function DirectionalStyle.DirectionalStyle_C.DetermineNextWeaponSlot");

	UDirectionalStyle_C_DetermineNextWeaponSlot_Params params;
