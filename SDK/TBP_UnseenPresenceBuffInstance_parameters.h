...
struct UTBP_UnseenPresenceBuffInstance_C_UpdateInvisibilityMaterial_Params
{
	...
	class UMaterialInstanceDynamic*                    MaterialInstance;                                          // 0x0010(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function TBP_UnseenPresenceBuffInstance.TBP_UnseenPresenceBuffInstance_C.ExecuteUbergraph_TBP_UnseenPresenceBuffInstance
struct UTBP_UnseenPresenceBuffInstance_C_ExecuteUbergraph_TBP_UnseenPresenceBuffInstance_Params
{
