...
class UTBP_XP_DiablerizedPlayer_C : public UTigerExperienceEvent
{
public:
	...
	int                                                TotalAmountOfGroupMembers;                                 // 0x005C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass TBP_XP_DiablerizedPlayer.TBP_XP_DiablerizedPlayer_C");
		return ptr;
	}
