...
// BlueprintGeneratedClass TBP_XP_OnCollectibleFound.TBP_XP_OnCollectibleFound_C
// 0x0000 (FullSize[0x0050] - InheritedSize[0x0050])
class UTBP_XP_OnCollectibleFound_C : public UTigerExperienceEvent
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass TBP_XP_OnCollectibleFound.TBP_XP_OnCollectibleFound_C");
		return ptr;
	}
