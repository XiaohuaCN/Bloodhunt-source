...
public:
	...
	class UTigerPartyInvite*                           Invite;                                                    // 0x0358(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TBP_UI_Social_PartyInvite_PlayerCard.TBP_UI_Social_PartyInvite_PlayerCard_C");
		return ptr;
	}
