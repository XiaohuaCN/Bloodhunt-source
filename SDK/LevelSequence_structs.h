...
{
	unsigned char                                      UnknownData_ROFR[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FLevelSequenceObject
{
	...
	unsigned char                                      UnknownData_CAJB[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelSequenceAnimSequenceLinkItem
{
	...
	unsigned char                                      UnknownData_GFJ0[0x5];                                     // 0x002B(0x0005) MISSED OFFSET (PADDING)
...
struct FLevelSequenceSnapshotSettings
{
	...
	unsigned char                                      UnknownData_39R2[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelSequencePlayerSnapshot
{
	...
	unsigned char                                      UnknownData_ID7L[0x4];                                     // 0x00A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9LCM[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QENK[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_C87X[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
