...
struct FAnimationEventBinding
{
	...
	unsigned char                                      UnknownData_6PH3[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9IL2[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FSlateChildSize
{
	...
	unsigned char                                      UnknownData_XXZ7[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FRadialBoxSettings
{
	...
	unsigned char                                      UnknownData_GCL8[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FUserWidgetPool
{
	...
	unsigned char                                      UnknownData_MVBR[0x60];                                    // 0x0020(0x0060) MISSED OFFSET (PADDING)
...
struct FSlateMeshVertex
{
	...
	struct FCoreUObject_FColor                         Color;                                                     // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FWidgetAnimationBinding
{
	...
	unsigned char                                      UnknownData_QVY1[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FBlueprintWidgetAnimationDelegateBinding
{
	...
	unsigned char                                      UnknownData_60KL[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDelegateRuntimeBinding
{
	...
	unsigned char                                      UnknownData_6ZGP[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FWidgetNavigationData
{
	...
	unsigned char                                      UnknownData_8WXZ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEventReply
{
	unsigned char                                      UnknownData_TFOL[0xB8];                                    // 0x0000(0x00B8) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8WOF[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FMovieSceneMarginSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_0DBU[0x7];                                     // 0x02B9(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VMD5[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)
