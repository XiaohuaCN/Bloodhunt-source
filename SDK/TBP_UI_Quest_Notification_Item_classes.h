...
public:
	...
	class UTigerStyledRichTextBlock*                   QuestNameText;                                             // 0x0298(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TBP_UI_Quest_Notification_Item.TBP_UI_Quest_Notification_Item_C");
		return ptr;
	}



	void SetupDataFromQuest(class UTigerQuest* TigerChallenge);
	void Construct();
	void ExecuteUbergraph_TBP_UI_Quest_Notification_Item(int EntryPoint);
};
