...
// 0x0000 (FullSize[0x00C4] - InheritedSize[0x00C4])
...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass TBP_ContextualHelp_Tutorial_Input_Walk.TBP_ContextualHelp_Tutorial_Input_Walk_C");
		return ptr;
	}
