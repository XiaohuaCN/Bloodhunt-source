...
{
public:
	unsigned char                                      UnknownData_OOSB[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BD68[0x3C];                                    // 0x0034(0x003C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_QB4C[0x3];                                     // 0x00B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8MZX[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XP73[0x458];                                   // 0x0028(0x0458) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZAGZ[0x60];                                    // 0x0578(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WQ3T[0x8];                                     // 0x0228(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UX2K[0x4];                                     // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NB9L[0x4];                                     // 0x0274(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EDSV[0x8];                                     // 0x0680(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7I0P[0x8];                                     // 0x0160(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_X5UN[0x70];                                    // 0x0040(0x0070) MISSED OFFSET (PADDING)
