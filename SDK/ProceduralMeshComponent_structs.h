...
struct FProcMeshTangent
{
	...
	unsigned char                                      UnknownData_AHBS[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FProcMeshVertex
{
	...
	struct FCoreUObject_FColor                         Color;                                                     // 0x0028(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FProcMeshSection
{
	...
	unsigned char                                      UnknownData_BWBB[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (PADDING)
