...
// Function:
//		Offset -> 0x016C0340
//		Name   -> Function TBP_XP_FeedingHighPotenceBlood.TBP_XP_FeedingHighPotenceBlood_C.GetExperienceAmount
...
void UTBP_XP_FeedingHighPotenceBlood_C::GetExperienceAmount(class ATigerPlayer* Player, class ATigerCharacter* EventTiedCharacter, Tiger_EMatchBalanceMode BalanceMode, int* OutOwnPlayerExperienceGain, int* OutExperienceToAddToEveryGroupMemberIncludingSelf)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function TBP_XP_FeedingHighPotenceBlood.TBP_XP_FeedingHighPotenceBlood_C.GetExperienceAmount");

	UTBP_XP_FeedingHighPotenceBlood_C_GetExperienceAmount_Params params;
