...
class UTBP_XP_FeedingRat_C : public UTigerExperienceEvent
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass TBP_XP_FeedingRat.TBP_XP_FeedingRat_C");
		return ptr;
	}
