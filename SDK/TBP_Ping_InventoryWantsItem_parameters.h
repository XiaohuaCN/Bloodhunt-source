...
struct UTBP_Ping_InventoryWantsItem_C_GetNotificationVoiceAudioEvent_Params
{
...
struct UTBP_Ping_InventoryWantsItem_C_GetInventoryTooltipText_Params
{
	class UTigerItemAsset*                             InModAsset;                                                // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
