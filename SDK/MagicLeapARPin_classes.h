...
public:
	...
	unsigned char                                      UnknownData_U5D5[0x2];                                     // 0x020E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2MSM[0xF0];                                    // 0x02C0(0x00F0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_36EL[0x7];                                     // 0x0239(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_6FZB[0x7];                                     // 0x0229(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<struct FGuid, class AMagicLeapARPinInfoActorBase*> AllInfoActors;                                             // 0x0230(0x0050) (NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_VW80[0x8];                                     // 0x0280(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_COEM[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OCSU[0xF];                                     // 0x00A1(0x000F) MISSED OFFSET (PADDING)
