...
enum class AkAudio_EAkChannelConfiguration : uint8_t
{
	...
	AkChannelConfiguration__AK_Audio_Objects = 2,
	AkChannelConfiguration__Ak_1   = 3,
	AkChannelConfiguration__Ak_2   = 4,
	AkChannelConfiguration__Ak_201 = 5,
	AkChannelConfiguration__Ak_3   = 6,
	AkChannelConfiguration__Ak_301 = 7,
	AkChannelConfiguration__Ak_4   = 8,
	AkChannelConfiguration__Ak_401 = 9,
	AkChannelConfiguration__Ak_5   = 10,
	AkChannelConfiguration__Ak_501 = 11,
	AkChannelConfiguration__Ak_7   = 12,
	AkChannelConfiguration__Ak_5_1 = 13,
	AkChannelConfiguration__Ak_7_1 = 14,
	AkChannelConfiguration__Ak_7_101 = 15,
	AkChannelConfiguration__Ak_Auro_9 = 16,
	AkChannelConfiguration__Ak_Auro_10 = 17,
	AkChannelConfiguration__Ak_Auro_11 = 18,
	AkChannelConfiguration__Ak_Auro_13 = 19,
	AkChannelConfiguration__Ak_Ambisonics_1st_order = 20,
	AkChannelConfiguration__Ak_Ambisonics_2nd_order = 21,
	AkChannelConfiguration__Ak_Ambisonics_3rd_order = 22,
	AkChannelConfiguration__Ak_Ambisonics_4th_order = 23,
	AkChannelConfiguration__Ak_Ambisonics_5th_order = 24,
	AkChannelConfiguration__AkChannelConfiguration_MAX = 25,
...
struct FAkMainOutputSettings
{
	...
	unsigned char                                      UnknownData_0YUU[0x3];                                     // 0x0014(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_RA7L[0x3];                                     // 0x0018(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_ZIFK[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FAkSpatialAudioSettings
{
	...
	unsigned char                                      UnknownData_JWTW[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkCommunicationSettings
{
	...
	unsigned char                                      UnknownData_8OYL[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkCommunicationSettingsWithSystemInitialization : public FAkCommunicationSettings
{
	...
	unsigned char                                      UnknownData_O0N5[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FAkAdvancedInitializationSettings
{
	...
	unsigned char                                      UnknownData_NEYZ[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LT2Y[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AJNW[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkAdvancedInitializationSettingsWithMultiCoreRendering : public FAkAdvancedInitializationSettings
{
	...
	unsigned char                                      UnknownData_9I8X[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkAndroidAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_2D1G[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FAkCommonInitializationSettings
{
	...
	unsigned char                                      UnknownData_X464[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkCommonInitializationSettingsWithSampleRate : public FAkCommonInitializationSettings
{
	...
	unsigned char                                      UnknownData_20DJ[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FAkGeometrySurfaceOverride
{
	...
	unsigned char                                      UnknownData_GLPU[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QM83[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FAkHololensAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_9M6T[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (PADDING)
...
struct FAkPluginInfo
{
	...
	unsigned char                                      UnknownData_PVBY[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkAudioSession
{
	...
	unsigned char                                      UnknownData_W4J1[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_JEKH[0x3];                                     // 0x0008(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FAkPS4AdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_70DZ[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FAkPS5AdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_XPK7[0x2];                                     // 0x0032(0x0002) MISSED OFFSET (PADDING)
...
struct FAkPoly
{
	...
	unsigned char                                      UnknownData_D7TC[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              SurfaceArea;                                               // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_L5G4[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FAkCommunicationSettingsWithCommSelection : public FAkCommunicationSettings
{
	...
	unsigned char                                      UnknownData_KOKL[0x3];                                     // 0x0020(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_0Q27[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
{
	bool                                               UseHeadMountedDisplayAudioDevice;                          // 0x0030(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_QIQN[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	bool                                               UseHeadMountedDisplayAudioDevice;                          // 0x0030(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_NCQR[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (PADDING)
...
struct FAkXboxOneGDKAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_7T5P[0x1];                                     // 0x0033(0x0001) MISSED OFFSET (PADDING)
...
struct FAkXboxOneAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	uint16_t                                           MaximumNumberOfXMAVoices;                                  // 0x0030(0x0002) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHardwareCodecLowLatencyMode;                            // 0x0032(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_O3TV[0x1];                                     // 0x0033(0x0001) MISSED OFFSET (PADDING)
...
struct FAkAudioEventTrackKey
{
	...
	unsigned char                                      UnknownData_CP72[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneTangentDataSerializationHelper
{
	...
	unsigned char                                      UnknownData_2P2R[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneFloatValueSerializationHelper
{
	...
	unsigned char                                      UnknownData_G3ZJ[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneFloatChannelSerializationHelper
{
	...
	unsigned char                                      UnknownData_FIRS[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S2R3[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6SBK[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8SGI[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FAkExternalSourceInfo
{
	...
	unsigned char                                      UnknownData_TK1K[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_76K4[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VEWW[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FAkGeometrySurfacePropertiesToMap
{
	...
	unsigned char                                      UnknownData_MIWV[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CM3D[0x40];                                    // 0x0000(0x0040) MISSED OFFSET (PADDING)
...
struct FAkEdgeInfo
{
	unsigned char                                      UnknownData_RR8P[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FAkAcousticTextureParams
{
	...
	unsigned char                                      UnknownData_HWRP[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
