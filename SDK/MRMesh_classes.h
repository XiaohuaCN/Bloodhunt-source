...
public:
	...
	unsigned char                                      UnknownData_6K0O[0x4];                                     // 0x020C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FCoreUObject_FColor>                 BlockVertexColors;                                         // 0x0210(0x0010) (Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_ROBZ[0x4];                                     // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QGPM[0x20];                                    // 0x0250(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_T6K7[0x10];                                    // 0x0450(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2ZQO[0x5];                                     // 0x0473(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I28T[0x80];                                    // 0x0490(0x0080) MISSED OFFSET (PADDING)
