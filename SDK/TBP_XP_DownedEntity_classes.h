...
class UTBP_XP_DownedEntity_C : public UTigerExperienceEvent
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass TBP_XP_DownedEntity.TBP_XP_DownedEntity_C");
		return ptr;
	}
