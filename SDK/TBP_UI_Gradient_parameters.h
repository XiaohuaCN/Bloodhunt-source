...
struct UTBP_UI_Gradient_C_PreConstruct_Params
{
	bool                                               IsDesignTime;                                              // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};

// Function TBP_UI_Gradient.TBP_UI_Gradient_C.Construct
struct UTBP_UI_Gradient_C_Construct_Params
{
};

// Function TBP_UI_Gradient.TBP_UI_Gradient_C.ExecuteUbergraph_TBP_UI_Gradient
struct UTBP_UI_Gradient_C_ExecuteUbergraph_TBP_UI_Gradient_Params
{
