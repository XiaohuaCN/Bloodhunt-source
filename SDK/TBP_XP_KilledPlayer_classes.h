...
class UTBP_XP_KilledPlayer_C : public UTigerExperienceEvent
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass TBP_XP_KilledPlayer.TBP_XP_KilledPlayer_C");
		return ptr;
	}
