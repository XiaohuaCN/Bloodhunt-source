...
struct UTBP_Modifier_ChangeFOV_1_C_OnModEquipped_Params
{
...
struct UTBP_Modifier_ChangeFOV_1_C_OnModUnequipped_Params
{
	class UTigerEquippedModModifierValues*             Modifiers;                                                 // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function TBP_Modifier_ChangeFOV_2.TBP_Modifier_ChangeFOV_1_C.ExecuteUbergraph_TBP_Modifier_ChangeFOV_2
struct UTBP_Modifier_ChangeFOV_1_C_ExecuteUbergraph_TBP_Modifier_ChangeFOV_2_Params
{
